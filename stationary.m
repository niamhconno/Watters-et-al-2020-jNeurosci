...
%%%     --Identifies potentially stationary objects (identified according  
%%%         to conditions defined within function!)
...
disp('To be considered stationary, objects must remain within')
fprintf('+/-%.1f pixels of their starting coordinate for %.0f%% of the image\n', x_range, stationary_percent*100)
       ...
       for i = 1:size(stationary_check,2)  
          ...
          if isnan(stationary_check(1,i))    
             ...
             if sum(stationary_check(2:end,i)) > kymo_size * stationary_percent   
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
                %%% elseif object is identified in > X% of timepoints,
                %%% generate warning
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
             elseif sum(stationary_check(2:end,i)) > kymo_size * stationary_percent_outside 
                ...
                fprintf('This object (highlighted cyan) falls just outside stationary criteria.\n')
...
% Print stationary counts to screen for each time interval
disp('===================================================')
disp('===================================================')
disp('Stationary count complete for all time intervals!')
disp('Stationary counts:')
